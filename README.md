...
generateBipartiteGraph(n1, n2) - функция "случайной" генерации рёбер между двумя множествами двудольного графа. На выходе двумерный массив показывающая с какими вершинами второго множества, соединена ребром данная вершина первого множества.
